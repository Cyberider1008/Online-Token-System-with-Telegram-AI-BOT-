<%@ Page Title="Missed" Language="C#" MasterPageFile="~/menumaster.Master" AutoEventWireup="true" CodeBehind="missed.aspx.cs" Inherits="onlinetokensystem.missed" %>
...
<div class="col">
                    Current Token:
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="text-primary"  AutoCompleteType="Disabled" ReadOnly="True"></asp:TextBox>
                </div>
    <div class="col">
                    <asp:Label ID="Label1" runat="server" CssClass="text-primary" ></asp:Label>
                      ...
                      <div class="row mt-3">
<div class="col">
                 <asp:Button ID="Button2" runat="server" CssClass="btn-success btn-lg" Text="call" OnClick="Button2_Click"  />
    </div>
                          <div class="col">
                              <asp:Button ID="Button1" runat="server" CssClass="btn-success btn-lg" Text="Next" OnClick="Button1_Click" />
                 </div> </div>
