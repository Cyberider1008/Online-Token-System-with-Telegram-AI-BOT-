<%@ Page Title="Tokenapply" Language="C#" MasterPageFile="~/menumaster.Master" AutoEventWireup="true" CodeBehind="tokenapply.aspx.cs" Inherits="onlinetokensystem.tokenapply" %>
...
<div class="col-md-6">
                                    ...
                                    <div class="card-body card-block">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                        <asp:TextBox ID="TextBox3" runat="server" CssClass="txt"   TextMode="Date" AutoPostBack="True" OnTextChanged="TextBox3_TextChanged1"></asp:TextBox>
            ...
            runat="server" Display = "Dynamic" />
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                  <asp:TextBox ID="TextBox2" runat="server"  CssClass="form-control" AutoCompleteType="Disabled" MaxLength="10"></asp:TextBox> 
                                                    <span class="help-block"> <asp:RequiredFieldValidator ErrorMessage="*" ForeColor = "Red" ControlToValidate="TextBox2"
            runat="server" Display = "Dynamic" />
                         <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*correct phone number" ControlToValidate="TextBox2" ForeColor="Red" ValidationExpression="^[7-9][0-9]{9}$"></asp:RegularExpressionValidator>
 </span>
                                                </div>
                                            </div>
